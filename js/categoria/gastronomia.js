document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const librosGastronomia = libros.filter(libro => libro.categoria_id === 6);
        console.log('Libros de la categoría con categoria_id = 6:', librosGastronomia);

        const itemsSection = document.getElementById('gastronomia-items');
        itemsSection.innerHTML = ''; 

        librosGastronomia.forEach(libro => {

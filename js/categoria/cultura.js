document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const LibrosCultura = libros.filter(libro => libro.categoria_id === 4);
        console.log('Libros de la categoría con categoria_id = 4:', LibrosCultura);

        const itemsSection = document.getElementById('cultura-items');
        itemsSection.innerHTML = ''; 

        LibrosCultura.forEach(libro => {

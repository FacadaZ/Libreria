document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const librosTecnologia = libros.filter(libro => libro.categoria_id === 5);
        console.log('Libros de la categoría con categoria_id = 5:', librosTecnologia);

        const itemsSection = document.getElementById('tecnologia-items');
        itemsSection.innerHTML = ''; 

        librosTecnologia.forEach(libro => {
